package com.marvinguerra.sample.spring.config;

import com.marvinguerra.sample.AbstractSingleton;
...
//@Configuration
public class TomcatConfig extends AbstractSingleton implements
	...
	// I simplified it by making TomcatConfig implement
	// EmbeddedServletContainerCustomizer.
	...
	public void customize(ConfigurableEmbeddedServletContainer factory) {
		if (factory instanceof TomcatEmbeddedServletContainerFactory) {
			...
			logger.warn("customize() expected TomcatEmbeddedServletContainerFactory but was: "
					+ factory.getClass());
		}
	}
